...
Aerium is built on [Chromium](https://www.chromium.org/) via [ungoogled-chromium](https://github.com/ungoogled-software/ungoogled-chromium), packaged as a portable AppImage using [ungoogled-chromium-portablelinux](https://github.com/ungoogled-software/ungoogled-chromium-portablelinux)'s build system, with Aerium's own branding and defaults layered on top. Licensed under [GPLv2](LICENSE).
